...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--max_text_len", type=int, default=24, help="Maximum length of text description")
...
class BaseOptions_v5():
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--max_text_len", type=int, default=24, help="Length of motion")
